<html lang="en">
 ...
 <body>
   ...
   <div class="container">
    <div class="row">
	 <div class="col-md-12">
	  <h2>Breeder Register Form</h2><hr/>
	  <form class="form-horizontal" action="" enctype="multipart/form-data" method="POST">
	   ...
	   <div class="form-group">
	    <label for="breeds_kept" class="col-sm-2 control-label">Dog Breeds:</label>
		<div class="col-sm-6">
		 <input type="text" class="form-control" placeholder="What dog breeds do u keep?" id="breeds_kept" name="dog_breeds" value="" />	
		</div>
	   </div>
